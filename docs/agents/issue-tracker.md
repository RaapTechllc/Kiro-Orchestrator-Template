...
Issues and specs for this repo live as GitHub issues on `RaapTechllc/Kiro-Orchestrator-Template`. Use the `gh` CLI for all operations.
...
- **Resolve**: `gh issue comment <n> --body "..."`, then `gh issue close <n>`.
